...
void SettingsStore::begin(){
  ...
  s.bleAddress=prefs.getString("bleaddr",""); s.bleProtocol=prefs.getUChar("bleproto",0); s.bleAddress2=prefs.getString("bleaddr2",""); s.bleProtocol2=prefs.getUChar("bleproto2",0); s.pixelCount=prefs.getUShort("pixels",100);
}
void SettingsStore::saveAll(){
  ...
  prefs.putString("bleaddr",s.bleAddress);prefs.putUChar("bleproto",s.bleProtocol);prefs.putString("bleaddr2",s.bleAddress2);prefs.putUChar("bleproto2",s.bleProtocol2);prefs.putUShort("pixels",s.pixelCount);
}

...
assert 'op.localUnknown&&op.targetPartition&&f.runningPartition===op.targetPartition' in ui
assert '!op.localUnknown&&partitionOk&&versionOk&&commitOk' in ui
...
print('PASS: Anderson production audit invariants present')

...
const AndersonColorPaletteEntry ANDERSON_COLOR_PALETTE[] = {
  ...
  {"Orange",0xFF9500,0xFF3000},
  {"Yellow",0xFFFF00,0xFFFF00},
  {"Gold",0xFACC15,0xF18900},
  {"Amber",0xF59E0B,0xE44300},
  {"Green",0x22C55E,0x00FF00},
  {"Mint / light green",0x86EFAC,0x2AD555},
  {"Blue",0x2563EB,0x0000FF},
  {"Sky blue",0x0EA5E9,0x004BC6},
  {"Light blue",0x93C5FD,0x377CF9},
  {"Cyan",0x32D7D5,0x00FFFF},
  {"Teal",0x14B8A6,0x00664D},
  {"Purple",0x7E22CE,0x23018C},
  {"Lavender",0xC4B5FD,0x7A62F9},
  {"Magenta",0xFF00FF,0xFF00FF},
  {"Rose",0xFF2D55,0xFF020C},
  {"Pink",0xFF69B4,0xFF1560},
  {"Light pink",0xF9A8D4,0xEF4F98},
  {"White",0xFFFFFF,0xFFFFFF},
  {"Warm white",0xFFF1C7,0xFFDA7F},
  {"Icy white",0xDBEAFE,0xA7C8FC},
  {"Brown",0x92400E,0x360500},
  {"Dark brown",0x7C2D12,0x220200},
  {"Black / unlit",0x000000,0x000000}
};
...
// User-specified exact matches first, followed by a few historical Anderson colors
// where a near-tie is resolved toward the recognizable hue/lightness family.
static constexpr DirectMap DIRECT_MAP[] = {
  ...
  {0x34C759,0x00FF00},{0x22C55E,0x00FF00},{0x16A34A,0x00FF00},
  {0x0A84FF,0x0000FF},{0x2563EB,0x0000FF},{0x3B82F6,0x0000FF},
  {0xFF0000,0xFF0000},{0x00FF00,0x00FF00},{0x0000FF,0x0000FF},{0xFFFF00,0xFFFF00},{0x00FFFF,0x00FFFF},{0xFF00FF,0xFF00FF},{0xFFFFFF,0xFFFFFF},{0x000000,0x000000},
  {0xA855F7,0x23018C},{0xBF5AF2,0x23018C},{0x2DD4BF,0x00664D},{0x60A5FA,0x377CF9}
};

...
{"evt001","Cervical Cancer Awareness Month",EventKind::Awareness,RuleType::Month,1,0,0,0,0,1,Effect::Gradient,C2(0x00B4B4,0xFFFFFA),2 },
...
{"evt004","Thyroid Awareness Month",EventKind::Awareness,RuleType::Month,1,0,0,0,0,1,Effect::Gradient,C3(0x00B4B4,0xFF0024,0x0096FF),3 },
{"evt005","Birth Defects Awareness Month",EventKind::Awareness,RuleType::Month,1,0,0,0,0,1,Effect::Gradient,C2(0xFF0024,0x0096FF),2 },
{"evt006","New Year's Day",EventKind::Holiday,RuleType::Fixed,1,1,0,0,0,1,Effect::Jump,C2(0xFFA000,0xFFFFFA),2 },
{"evt007","World Braille Day",EventKind::Awareness,RuleType::Fixed,1,4,0,0,0,1,Effect::Gradient,C2(0xFFFF44,0x0096FF),2 },
{"evt008","Epiphany",EventKind::Holiday,RuleType::Fixed,1,6,0,0,0,1,Effect::Gradient,C2(0xFFFFFA,0xFFA000),2 },
{"evt009","Orthodox Christmas",EventKind::Holiday,RuleType::Fixed,1,7,0,0,0,1,Effect::Gradient,C3(0xFFFFFA,0xFFA000,0xFF0000),3 },
...
{"evt012","International Day of Education",EventKind::Awareness,RuleType::Fixed,1,24,0,0,0,1,Effect::Gradient,C2(0x0096FF,0xFFFFFA),2 },
...
{"evt015","Black History Month",EventKind::Awareness,RuleType::Month,2,0,0,0,0,1,Effect::Gradient,C3(0xFF0000,0x28FF00,0xFFA000),3 },
...
{"evt020","Groundhog Day",EventKind::Seasonal,RuleType::Fixed,2,2,0,0,0,1,Effect::Gradient,C2(0x28FF00,0xFFA000),2 },
{"evt021","National Wear Red Day",EventKind::Awareness,RuleType::NthWeekday,2,0,5,1,0,1,Effect::Breath,C1(0xFF0000),1 },
{"evt022","World Cancer Day",EventKind::Awareness,RuleType::Fixed,2,4,0,0,0,1,Effect::Gradient,C2(0xB464FF,0xFF0D00),2 },
...
{"evt030","Ramadan",EventKind::Holiday,RuleType::YearTable,0,0,0,0,0,30,Effect::Gradient,C2(0x28FF00,0xFFA000),2 },
{"evt031","World Day of Social Justice",EventKind::Awareness,RuleType::Fixed,2,20,0,0,0,1,Effect::Gradient,C2(0x0096FF,0xFFFFFA),2 },
...
{"evt033","Rare Disease Day",EventKind::Awareness,RuleType::MonthEnd,2,0,0,0,0,1,Effect::Gradient,C4(0xFF0024,0x0096FF,0x28FF00,0x5B00E6),4 },
...
{"evt043","World Hearing Day",EventKind::Awareness,RuleType::Fixed,3,3,0,0,0,1,Effect::Gradient,C2(0xA0A5AF,0xFF0000),2 },
...
{"evt047","Eid al-Fitr",EventKind::Holiday,RuleType::YearTable,0,0,0,0,0,1,Effect::Gradient,C2(0x28FF00,0xFFA000),2 },
{"evt048","World Down Syndrome Day",EventKind::Awareness,RuleType::Fixed,3,21,0,0,0,1,Effect::Gradient,C2(0x0096FF,0xFFFF44),2 },
{"evt049","World Water Day",EventKind::Awareness,RuleType::Fixed,3,22,0,0,0,1,Effect::Gradient,C2(0x0096FF,0x00B4B4),2 },
...
{"evt052","National Vietnam War Veterans Day",EventKind::Holiday,RuleType::Fixed,3,29,0,0,0,1,Effect::Gradient,C3(0xFFA000,0x28FF00,0xFF0000),3 },
{"evt053","International Transgender Day of Visibility",EventKind::Awareness,RuleType::Fixed,3,31,0,0,0,1,Effect::Gradient,C3(0x0096FF,0xFF0024,0xFFFFFA),3 },
{"evt054","Autism Acceptance Month",EventKind::Awareness,RuleType::Month,4,0,0,0,0,1,Effect::Gradient,C3(0xFFA000,0xFF0000,0x0096FF),3 },
...
{"evt058","National Minority Health Month",EventKind::Awareness,RuleType::Month,4,0,0,0,0,1,Effect::Gradient,C2(0x0096FF,0xFF0D00),2 },
{"evt059","Parkinson's Awareness Month",EventKind::Awareness,RuleType::Month,4,0,0,0,0,1,Effect::Gradient,C2(0xA0A5AF,0xFF0000),2 },
{"evt060","Donate Life Month",EventKind::Awareness,RuleType::Month,4,0,0,0,0,1,Effect::Gradient,C2(0x0096FF,0x28FF00),2 },
...
{"evt063","Passover",EventKind::Holiday,RuleType::YearTable,0,0,0,0,0,8,Effect::Gradient,C2(0x0096FF,0xFFFFFA),2 },
...
{"evt066","World Health Day",EventKind::Awareness,RuleType::Fixed,4,7,0,0,0,1,Effect::Gradient,C2(0x0096FF,0xFFFFFA),2 },
...
{"evt069","Yom HaShoah / Holocaust Remembrance Day",EventKind::Holiday,RuleType::YearTable,0,0,0,0,0,1,Effect::Gradient,C3(0xFFFF44,0x0096FF,0xFFFFFA),3 },
{"evt070","Earth Day",EventKind::Seasonal,RuleType::Fixed,4,22,0,0,0,1,Effect::Gradient,C2(0x28FF00,0x0096FF),2 },
{"evt071","World Malaria Day",EventKind::Awareness,RuleType::Fixed,4,25,0,0,0,1,Effect::Gradient,C2(0xFF0D00,0x0096FF),2 },
...
{"evt074","National Physical Fitness & Sports Month",EventKind::Awareness,RuleType::Month,5,0,0,0,0,1,Effect::Gradient,C2(0x28FF00,0x0096FF),2 },
{"evt075","Older Americans Month",EventKind::Awareness,RuleType::Month,5,0,0,0,0,1,Effect::Gradient,C2(0x5B00E6,0xA0A5AF),2 },
{"evt076","Asian American, Native Hawaiian & Pacific Islander Heritage Month",EventKind::Awareness,RuleType::Month,5,0,0,0,0,1,Effect::Gradient,C2(0xFF0000,0xFFA000),2 },
...
{"evt082","ALS Awareness Month",EventKind::Awareness,RuleType::Month,5,0,0,0,0,1,Effect::Gradient,C2(0x001478,0xFFFFFA),2 },
...
{"evt086","National Nurses Day",EventKind::Awareness,RuleType::Fixed,5,6,0,0,0,1,Effect::Gradient,C3(0xFFFFFA,0xFF0000,0x0096FF),3 },
...
{"evt089","International Nurses Day",EventKind::Awareness,RuleType::Fixed,5,12,0,0,0,1,Effect::Gradient,C2(0xFFFFFA,0x0096FF),2 },
...
{"evt092","International Day Against Homophobia, Biphobia & Transphobia",EventKind::Awareness,RuleType::Fixed,5,17,0,0,0,1,Effect::Gradient,C6(0xFF0000,0xFF0D00,0xFFFF44,0x28FF00,0x0096FF,0x5B00E6),6 },
{"evt093","HIV Vaccine Awareness Day",EventKind::Awareness,RuleType::Fixed,5,18,0,0,0,1,Effect::Gradient,C2(0xFFFFFA,0xFF0000),2 },
{"evt094","National Missing Children's Day",EventKind::Awareness,RuleType::Fixed,5,25,0,0,0,1,Effect::Gradient,C2(0x28FF00,0xFFA000),2 },
{"evt095","Memorial Day",EventKind::Holiday,RuleType::LastWeekday,5,0,1,0,0,1,Effect::Jump,C3(0xFF0000,0xFFFFFA,0x0D00FF),3 },
{"evt096","Eid al-Adha",EventKind::Holiday,RuleType::YearTable,0,0,0,0,0,1,Effect::Gradient,C2(0x28FF00,0xFFA000),2 },
{"evt097","World MS Day",EventKind::Awareness,RuleType::Fixed,5,30,0,0,0,1,Effect::Breath,C1(0xFF0D00),1 },
{"evt098","Pride Month",EventKind::Awareness,RuleType::Month,6,0,0,0,0,1,Effect::Gradient,C6(0xFF0000,0xFF0D00,0xFFFF44,0x28FF00,0x0096FF,0x5B00E6),6 },
...
{"evt101","Caribbean-American Heritage Month",EventKind::Awareness,RuleType::Month,6,0,0,0,0,1,Effect::Gradient,C4(0xFF0000,0xFFA000,0x28FF00,0x0096FF),4 },
...
{"evt109","Father's Day",EventKind::Holiday,RuleType::NthWeekday,6,0,0,3,0,1,Effect::Gradient,C2(0x001478,0xFFFFFA),2 },
...
{"evt113","Disability Pride Month",EventKind::Awareness,RuleType::Month,7,0,0,0,0,1,Effect::Gradient,C5(0xFF0000,0xFFA000,0xFFFFFA,0x0096FF,0x28FF00),5 },
...
{"evt123","National Breastfeeding Month",EventKind::Awareness,RuleType::Month,8,0,0,0,0,1,Effect::Gradient,C2(0xFFA000,0xFFFFFA),2 },
{"evt124","National Immunization Awareness Month",EventKind::Awareness,RuleType::Month,8,0,0,0,0,1,Effect::Gradient,C3(0xFFFFFA,0x0096FF,0x28FF00),3 },
{"evt125","Children's Eye Health & Safety Month",EventKind::Awareness,RuleType::Month,8,0,0,0,0,1,Effect::Gradient,C2(0xFFA000,0x28FF00),2 },
...
{"evt127","Psoriasis Awareness Month",EventKind::Awareness,RuleType::Month,8,0,0,0,0,1,Effect::Gradient,C2(0xFF0D00,0xB464FF),2 },
{"evt128","Purple Heart Day",EventKind::Holiday,RuleType::Fixed,8,7,0,0,0,1,Effect::Gradient,C2(0x5B00E6,0xFFFFFA),2 },
{"evt129","International Youth Day",EventKind::Awareness,RuleType::Fixed,8,12,0,0,0,1,Effect::Gradient,C2(0x28FF00,0x0096FF),2 },
{"evt130","National Aviation Day",EventKind::Awareness,RuleType::Fixed,8,19,0,0,0,1,Effect::Gradient,C2(0x0096FF,0xFFFFFA),2 },
{"evt131","World Humanitarian Day",EventKind::Awareness,RuleType::Fixed,8,19,0,0,0,1,Effect::Gradient,C2(0x0096FF,0xFFA000),2 },
{"evt132","Women's Equality Day",EventKind::Awareness,RuleType::Fixed,8,26,0,0,0,1,Effect::Gradient,C3(0x5B00E6,0xFFFFFA,0xFFA000),3 },
{"evt133","International Overdose Awareness Day",EventKind::Awareness,RuleType::Fixed,8,31,0,0,0,1,Effect::Gradient,C2(0x5B00E6,0xA0A5AF),2 },
{"evt134","Suicide Prevention Awareness Month",EventKind::Awareness,RuleType::Month,9,0,0,0,0,1,Effect::Gradient,C2(0x00B4B4,0x5B00E6),2 },
...
{"evt141","Healthy Aging Month",EventKind::Awareness,RuleType::Month,9,0,0,0,0,1,Effect::Gradient,C2(0x28FF00,0xFFA000),2 },
...
{"evt145","988 Day",EventKind::Awareness,RuleType::Fixed,9,8,0,0,0,1,Effect::Gradient,C2(0x00B4B4,0x5B00E6),2 },
{"evt146","World Suicide Prevention Day",EventKind::Awareness,RuleType::Fixed,9,10,0,0,0,1,Effect::Gradient,C3(0xFFFF44,0x00B4B4,0x5B00E6),3 },
...
{"evt148","Rosh Hashanah",EventKind::Holiday,RuleType::YearTable,0,0,0,0,0,2,Effect::Gradient,C3(0xFFFFFA,0x0096FF,0xFFA000),3 },
{"evt149","Grandparents Day",EventKind::Holiday,RuleType::NthWeekday,9,0,1,1,6,1,Effect::Gradient,C2(0x0096FF,0xFFFF44),2 },
{"evt150","Hispanic Heritage Month",EventKind::Awareness,RuleType::Fixed,9,15,0,0,0,31,Effect::Gradient,C5(0xFF0000,0xFFFFFA,0x28FF00,0xFFA000,0x0096FF),5 },
...
{"evt155","International Day of Peace",EventKind::Awareness,RuleType::Fixed,9,21,0,0,0,1,Effect::Gradient,C2(0xFFFFFA,0x0096FF),2 },
{"evt156","Celebrate Bisexuality Day",EventKind::Awareness,RuleType::Fixed,9,23,0,0,0,1,Effect::Gradient,C3(0xFF0024,0x5B00E6,0x0096FF),3 },
{"evt157","Gold Star Mother's & Family Day",EventKind::Holiday,RuleType::LastWeekday,9,0,0,0,0,1,Effect::Gradient,C3(0xFFA000,0x001478,0xFFFFFA),3 },
...
{"evt163","Down Syndrome Awareness Month",EventKind::Awareness,RuleType::Month,10,0,0,0,0,1,Effect::Gradient,C2(0x0096FF,0xFFFF44),2 },
{"evt164","Liver Cancer Awareness Month",EventKind::Awareness,RuleType::Month,10,0,0,0,0,1,Effect::Breath,C1(0x28FF00),1 },
{"evt165","Health Literacy Month",EventKind::Awareness,RuleType::Month,10,0,0,0,0,1,Effect::Gradient,C2(0x0096FF,0xFFFFFA),2 },
{"evt166","Substance Use Prevention Month",EventKind::Awareness,RuleType::Month,10,0,0,0,0,1,Effect::Breath,C1(0xFF0000),1 },
{"evt167","Cybersecurity Awareness Month",EventKind::Awareness,RuleType::Month,10,0,0,0,0,1,Effect::Gradient,C2(0x0096FF,0x28FF00),2 },
{"evt168","LGBTQ+ History Month",EventKind::Awareness,RuleType::Month,10,0,0,0,0,1,Effect::Gradient,C6(0xFF0000,0xFF0D00,0xFFFF44,0x28FF00,0x0096FF,0x5B00E6),6 },
{"evt169","Filipino American History Month",EventKind::Awareness,RuleType::Month,10,0,0,0,0,1,Effect::Gradient,C4(0x0096FF,0xFF0000,0xFFFFFA,0xFFA000),4 },
{"evt170","Pregnancy & Infant Loss Awareness Month",EventKind::Awareness,RuleType::Month,10,0,0,0,0,1,Effect::Gradient,C2(0xFF0024,0x0096FF),2 },
{"evt171","World Mental Health Day",EventKind::Awareness,RuleType::Fixed,10,10,0,0,0,1,Effect::Breath,C1(0x28FF00),1 },
{"evt172","National Coming Out Day",EventKind::Awareness,RuleType::Fixed,10,11,0,0,0,1,Effect::Gradient,C2(0x0096FF,0xFFFF44),2 },
...
{"evt175","Pregnancy & Infant Loss Remembrance Day",EventKind::Awareness,RuleType::Fixed,10,15,0,0,0,1,Effect::Gradient,C2(0xFF0024,0x0096FF),2 },
{"evt176","Spirit Day",EventKind::Awareness,RuleType::NthWeekday,10,0,4,3,0,1,Effect::Breath,C1(0x5B00E6),1 },
{"evt177","Dussehra",EventKind::Holiday,RuleType::YearTable,0,0,0,0,0,1,Effect::Gradient,C3(0xFFA000,0xFF0D00,0xFF0000),3 },
{"evt178","World Stroke Day",EventKind::Awareness,RuleType::Fixed,10,29,0,0,0,1,Effect::Gradient,C2(0x0096FF,0x5B00E6),2 },
{"evt179","Halloween",EventKind::Seasonal,RuleType::Fixed,10,31,0,0,0,1,Effect::Strobe,C3(0xFF0D00,0x5B00E6,0x28FF00),3 },
{"evt180","Native American Heritage Month",EventKind::Awareness,RuleType::Month,11,0,0,0,0,1,Effect::Gradient,C4(0xFF0000,0xFFA000,0xFFFFFA,0x0096FF),4 },
...
{"evt189","All Saints' Day",EventKind::Holiday,RuleType::Fixed,11,1,0,0,0,1,Effect::Gradient,C2(0xFFFFFA,0xFFA000),2 },
...
{"evt196","Transgender Day of Remembrance",EventKind::Awareness,RuleType::Fixed,11,20,0,0,0,1,Effect::Gradient,C3(0x0096FF,0xFF0024,0xFFFFFA),3 },
{"evt197","Thanksgiving",EventKind::Holiday,RuleType::NthWeekday,11,0,4,4,0,1,Effect::Jump,C3(0xFF0D00,0xFF0000,0xFFA000),3 },
{"evt198","Native American Heritage Day",EventKind::Awareness,RuleType::NthWeekday,11,0,4,4,1,1,Effect::Gradient,C3(0xFF0000,0xFFA000,0xFFFFFA),3 },
...
{"evt201","International Day of Persons with Disabilities",EventKind::Awareness,RuleType::Fixed,12,3,0,0,0,1,Effect::Gradient,C2(0x5B00E6,0x0096FF),2 },
{"evt202","Hanukkah",EventKind::Holiday,RuleType::YearTable,0,0,0,0,0,8,Effect::Gradient,C2(0x0096FF,0xFFFFFA),2 },
...
{"evt204","Human Rights Day",EventKind::Awareness,RuleType::Fixed,12,10,0,0,0,1,Effect::Gradient,C2(0x0096FF,0xFFFFFA),2 },
{"evt205","Bill of Rights Day",EventKind::Awareness,RuleType::Fixed,12,15,0,0,0,1,Effect::Jump,C3(0xFF0000,0xFFFFFA,0x0D00FF),3 },
{"evt206","Winter Solstice",EventKind::Seasonal,RuleType::Fixed,12,21,0,0,0,1,Effect::Gradient,C3(0xFFFFFA,0x00B4B4,0x0096FF),3 },

...
{"presidents","Presidents' Day",EventKind::Holiday,RuleType::NthWeekday,2,0,1,3,0,1,Effect::Jump,C3(0xFF0000,0xFFFFFF,0x0000FF),3},
{"valentine","Valentine's Day",EventKind::Holiday,RuleType::Fixed,2,14,0,0,0,1,Effect::Breath,C3(0xFF020C,0xFF1560,0xFFFFFF),3},
{"mardigras","Mardi Gras",EventKind::Holiday,RuleType::EasterOffset,0,0,0,0,-47,1,Effect::Jump,C3(0x23018C,0x00FF00,0xF18900),3},
{"stpatrick","St. Patrick's Day",EventKind::Holiday,RuleType::Fixed,3,17,0,0,0,1,Effect::Jump,C3(0x00FF00,0x00FF00,0xF18900),3},
{"aprilfools","April Fools' Day",EventKind::Holiday,RuleType::Fixed,4,1,0,0,0,1,Effect::Strobe,C4(0xFF3000,0x23018C,0x00FF00,0xFF1560),4},
{"autism","Autism Acceptance Month",EventKind::Awareness,RuleType::Month,4,0,0,0,0,1,Effect::Gradient,C5(0xF18900,0x0000FF,0x00FF00,0x23018C,0xFF0000),5},
{"saam","Sexual Assault Awareness Month",EventKind::Awareness,RuleType::Month,4,0,0,0,0,1,Effect::Gradient,C2(0x00664D,0x00664D),2},
{"easter","Easter",EventKind::Holiday,RuleType::EasterOffset,0,0,0,0,0,1,Effect::Gradient,C5(0xEF4F98,0x7A62F9,0x377CF9,0xFFDA7F,0xFFFFFF),5},
{"earth","Earth Day",EventKind::Awareness,RuleType::Fixed,4,22,0,0,0,1,Effect::Gradient,C3(0x00FF00,0x004BC6,0x0000FF),3},
...
{"fathers","Father's Day",EventKind::Holiday,RuleType::NthWeekday,6,0,0,3,0,1,Effect::Gradient,C3(0x0000FF,0x377CF9,0xFFFFFF),3},
{"juneteenth","Juneteenth",EventKind::Holiday,RuleType::Fixed,6,19,0,0,0,1,Effect::Jump,C4(0xFF0000,0x000000,0x00FF00,0xF18900),4},
{"independence","Independence Day",EventKind::Holiday,RuleType::Fixed,7,4,0,0,0,1,Effect::Jump,C3(0xFF0000,0xFFFFFF,0x0000FF),3},
{"labor","Labor Day",EventKind::Holiday,RuleType::NthWeekday,9,0,1,1,0,1,Effect::Jump,C3(0xFF0000,0xFFFFFF,0x0000FF),3},
{"childcancer","Childhood Cancer Awareness Month",EventKind::Awareness,RuleType::Month,9,0,0,0,0,1,Effect::Strobe,C2(0xF18900,0xE44300),2},
{"suicide","Suicide Prevention Awareness Month",EventKind::Awareness,RuleType::Month,9,0,0,0,0,1,Effect::Gradient,C2(0x00664D,0x23018C),2},
{"988","988 Day",EventKind::Awareness,RuleType::Fixed,9,8,0,0,0,1,Effect::Breath,C3(0x00664D,0x23018C,0xFFFFFF),3},
{"wspd","World Suicide Prevention Day",EventKind::Awareness,RuleType::Fixed,9,10,0,0,0,1,Effect::Gradient,C2(0x00664D,0x23018C),2},
{"patriot","Patriot Day / 9-11 Remembrance",EventKind::Holiday,RuleType::Fixed,9,11,0,0,0,1,Effect::Jump,C3(0xFF0000,0xFFFFFF,0x0000FF),3},
{"breast","Breast Cancer Awareness Month",EventKind::Awareness,RuleType::Month,10,0,0,0,0,1,Effect::Breath,C2(0xFF1560,0xEF4F98),2},
...
{"indigenous","Indigenous Peoples' / Columbus Day",EventKind::Holiday,RuleType::NthWeekday,10,0,1,2,0,1,Effect::Gradient,C3(0xFF3000,0xF18900,0x360500),3},
{"halloween","Halloween",EventKind::Holiday,RuleType::Fixed,10,31,0,0,0,1,Effect::Strobe,C3(0xFF3000,0x23018C,0x00FF00),3},
{"november","November / Autumn Theme",EventKind::Seasonal,RuleType::Month,11,0,0,0,0,1,Effect::Gradient,C4(0xFF3000,0x360500,0xF18900,0x220200),4},
{"diabetes","Diabetes Awareness Month",EventKind::Awareness,RuleType::Month,11,0,0,0,0,1,Effect::Gradient,C2(0x0000FF,0x377CF9),2},
{"veterans","Veterans Day",EventKind::Holiday,RuleType::Fixed,11,11,0,0,0,1,Effect::Jump,C3(0xFF0000,0xFFFFFF,0x0000FF),3},
{"thanksgiving","Thanksgiving",EventKind::Holiday,RuleType::NthWeekday,11,0,4,4,0,1,Effect::Gradient,C4(0xFF3000,0x360500,0xF18900,0xFF0000),4},
{"december","December / Winter Theme",EventKind::Seasonal,RuleType::Month,12,0,0,0,0,1,Effect::Strobe,C4(0xA7C8FC,0x377CF9,0xFFFFFF,0x004BC6),4},
{"hanukkah","Hanukkah",EventKind::Holiday,RuleType::Hanukkah,12,0,0,0,0,8,Effect::Strobe,C3(0x0000FF,0xFFFFFF,0xF18900),3},
{"christmas","Christmas Day",EventKind::Holiday,RuleType::Fixed,12,25,0,0,0,1,Effect::Jump,C3(0xFF0000,0x00FF00,0xFFFFFF),3},
{"kwanzaa","Kwanzaa",EventKind::Holiday,RuleType::Fixed,12,26,0,0,0,7,Effect::Gradient,C3(0xFF0000,0x000000,0x00FF00),3},
{"nye","New Year's Eve",EventKind::Holiday,RuleType::Fixed,12,31,0,0,0,1,Effect::Strobe,C3(0xF18900,0xFFFFFF,0x004BC6),3}
};

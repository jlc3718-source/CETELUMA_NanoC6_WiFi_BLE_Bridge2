...
static constexpr const char* ANDERSON_FIRMWARE_VERSION="3.1.8";
...
void setupRoutes(){
  ...
  server.on("/api/ble/diagnostics",HTTP_GET,[]{if(!requireAdmin())return;sendJson(ble.diagnosticsJson(true));});

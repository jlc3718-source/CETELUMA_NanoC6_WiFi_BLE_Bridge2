...
static constexpr const char* ANDERSON_FIRMWARE_VERSION="4.0.6";
...
void loop(){
  ...
  // Yield enough time for the IDF idle task while preserving BLE timing.
  delay(10);
}
